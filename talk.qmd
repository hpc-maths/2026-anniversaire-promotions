...
<div class="ai-legend">
  ...
  <span>jauge indicative ; les valeurs mesurées figurent au bas de chaque marche</span>
</div>
<div class="stairs">
  <div class="stair" style="--agent:8%">
    ...
    <div class="stair-body">Copilot propose la suite du code courant. ChatGPT répond à côté, hors du projet.</div>
    <div class="stair-score is-empty">non mesuré</div>
  </div>
  ...
  <div class="stair" style="--agent:85%">
    ...
    <div class="stair-score">96&nbsp;%</div>
  </div>
</div>
<div class="ai-source">Part de tickets GitHub réels résolus sans intervention. SWE-bench, puis SWE-bench Verified. Meilleur système publié de chaque année.</div>
<div class="ai-kpis">
  <div class="ai-kpi">
    <div class="ai-kpi-value">2&nbsp;% <span class="ai-arrow">&rarr;</span> 96&nbsp;%</div>
    <div class="ai-kpi-label">de tickets réels résolus seul, en moins de trois ans</div>
  </div>
  <div class="ai-kpi">
    <div class="ai-kpi-value">1 correctif sur 5</div>
    <div class="ai-kpi-label">accepté à tort : les jeux de tests deviennent le maillon faible</div>
  </div>
  <div class="ai-kpi">
    <div class="ai-kpi-value">écrire <span class="ai-arrow">&rarr;</span> valider</div>
    <div class="ai-kpi-label">là où se déplace le travail : portage, refactoring, tests</div>
  </div>
</div>
<div class="ai-takeaway">Écrire le correctif est devenu facile. Savoir s'il est juste dépend des tests.</div>
```
    ...
    <div class="rail-track">
      ...
      <div class="rail-node">
        ...
        <div class="rail-body">
          ...
          <div class="rail-text">Sur des problèmes d'Erdős énoncés en Lean, les résultats restent marginaux.</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="ai-kpis">
  ...
  <div class="ai-kpi">
    <div class="ai-kpi-value">3&nbsp;%</div>
    <div class="ai-kpi-label">des problèmes d'Erdős ouverts démontrés en Lean</div>
  </div>
</div>
